...
function renderizarCachorro() {
    ...
    const categoriaCachorro = todosProdutos.filter(produto => produto.categoriaAnimal.includes("cachorro"));
    ...
    for (let i = 0; i < categoriaCachorro.length; i++) {
        ...
        novaDiv.innerHTML = `
            ...
            <p class="card-informacoes">${categoriaCachorro[i].cod}</p>
...
function renderizarGato() {
    ...
    const categoriaGato = todosProdutos.filter(produto => produto.categoriaAnimal.includes("gato"));
    ...
    for (let i = 0; i < categoriaGato.length; i++) {
        ...
        novaDiv.innerHTML = `
            ...
            <p class="card-informacoes">${categoriaGato[i].cod}</p>
...
function renderizarOutros() {
    ...
    const categoriaOutros = todosProdutos.filter(produto => produto.categoriaAnimal.includes("outros-animais"));
    ...
    for (let i = 0; i < categoriaOutros.length; i++) {
        ...
        novaDiv.innerHTML = `
            ...
            <p class="card-informacoes">${categoriaOutros[i].cod}</p>
